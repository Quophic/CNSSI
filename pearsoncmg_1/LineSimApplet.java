...
// 把原本继承的 Applet 改为 JPanel
public class LineSimApplet extends JPanel {
    // buttons
    ...
    MyChoice rate = new MyChoice(new String[] { "512 kps", "1 Mbps", "10 Mbps", "100 Mbps" },
            new double[] { 512E3, 1E6, 10E6, 100E6 }, 2);
    MyChoice size = new MyChoice(new String[] { "100 Bytes", "500 Bytes", "1 kBytes" }, new double[] { 8E2, 4E3, 8E3 },
            1);
    // to simulate time
    Thread timerThread;
    TickTask timerTask;
        ...
        public void run() {
            while (LineSimApplet.this.simulationRunning) {
                ...
                if (counter >= length) {
                    ...
                    try {
                        synchronized(LineSimApplet.this.timerThread){
                            LineSimApplet.this.timerThread.wait();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
